...
const sendVerificationEmail = async (email, token) => {
  ...
  return await sendEmail({
    to: email,
    subject: "Verify your Developer Center account",
    text: `Welcome to Developer Center! Please verify your email address by visiting this link: ${verificationLink}. This link is valid for 24 hours.`,
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 8px;">
        <h2 style="color: #6366f1; text-align: center;">Welcome to Developer Center</h2>
        <p>Hi there,</p>
        <p>Thank you for signing up! Please verify your email address to activate your Developer Center account.</p>
        ...
        <p style="font-size: 12px; color: #666; text-align: center;">If you didn't create a Developer Center account, please ignore this email.</p>
      </div>
    `,
  });
};
...
const sendPasswordResetEmail = async (email, token) => {
  ...
  return await sendEmail({
    to: email,
    subject: "Reset your Developer Center password",
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 8px;">
        ...
        <p>Hi there,</p>
        <p>We received a request to reset the password for your Developer Center account. Click the button below to set a new password:</p>
        <div style="text-align: center; margin: 30px 0;">
