...
export default function ProjectFilters({ filters, onChange }) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-2.5 font-ui">
      {/* Search */}
      <div className="relative flex-1 min-w-[180px] max-w-xs">
        <svg
          className="absolute left-2.5 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-gh-muted"
      ...
      <select
        ...
        className="gh-input w-auto text-xs font-mono py-1.5 px-2.5"
      >
      ...
      {(filters.search || filters.status || filters.priority) && (
        <button
          ...
          className="btn-ghost text-xs py-1 px-2 font-mono"
        >
